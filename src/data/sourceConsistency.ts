...
export const SOURCE_CONSISTENCY: SourceConsistency[] = [
  ...
  },
  {
    ...
    label: 'Coal',
    consistencyScore: 84,
    inconsistencyScore: 16,
    band: 'high',
    capacityFactorTypical: 0.45,
    capacityFactorRange: [0.2, 0.7],
    diurnalSwing: 20,
    seasonalSwing: 25,
    forecastErrorPct: 3,
    firmCredit: 0.85,
    timescale: 'days-weeks',
    drivers: ['Unit commitment', 'Fuel inventory', 'Outage schedules', 'Emissions limits'],
    strengths: ['Dispatchable energy', 'On-site fuel stock', 'Historical baseload role'],
    risks: ['High CO2', 'Cycling wear', 'Retirement / economics', 'Water / air permits'],
    caNote: 'Near-zero remaining coal capacity in CA; still material nationally for firm thermal.',
  },
  {
    technology: 'other',
    label: 'Other / imports / oil',
    consistencyScore: 48,
    ...
    drivers: ['Neighbor BAs', 'COI / SWPL limits', 'Market prices', 'Wildfire / outages', 'Oil peakers'],
    ...
    caNote: 'Imports and residual oil/other look consistent until a West-wide peak day tightens every path.',
  },
]

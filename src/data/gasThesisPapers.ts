...
export const RELATED_PAPERS: ThesisPaper[] = [
  ...
  },
  {
    ...
    authors: 'Trinity Manning-Pickett, Naser Ameen',
    org: 'EIA Today in Energy',
    year: 2026,
    kind: 'agency',
    stance: 'balanced',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67944',
    summary:
      'August 2026 STEO brief: marketed gas 122.5 Bcf/d in 2026 vs 118.5 record in 2025. 1H26 already 121.3 Bcf/d (+4.6 vs 1H25). Growth is Permian associated gas (WTI, rising GOR) and Haynesville dry gas (Henry Hub ~$3.44, Gulf LNG pull). Official near-term supply is still making records, which sits next to Chronometer 2030 shortage arithmetic.',
    keyClaims: [
      'Marketed production 122.5 Bcf/d forecast 2026.',
      'Permian 29.2 Bcf/d (+6%); Haynesville +9% / +1.3 Bcf/d.',
      'Henry Hub ~$3.44/MMBtu; not a 2026 shortage print.',
    ],
    tags: ['EIA', 'STEO', 'production', 'Permian', 'Haynesville'],
    relatedness: 80,
    mapFocus: ['permian', 'haynesville', 'gulf-lng'],
  },
  {
    id: 'eia-steo',
    title: 'Short-Term Energy Outlook (monthly)',
    authors: 'U.S. Energy Information Administration',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    ...
    summary:
      'Parent feed for TIE notes like 67944. August 2026: record production, LNG ~16.5 Bcf/d in 3Q26 (Freeport maintenance), Henry Hub ~$2.87 in 3Q26, inventories heading into winter at a decade high (~3,985 Bcf end-Oct). Living official 12-24 month balance, not a 2030 closed-loop model.',
    keyClaims: [
      'Near-term U.S. gas is long production and long storage.',
      'LNG feedgas and weather move the 3-12 month print more than AI.',
      'Refresh monthly; do not freeze one TIE article.',
    ],
    tags: ['EIA', 'STEO', 'LNG', 'storage', 'prices'],
    relatedness: 84,
    mapFocus: ['gulf-lng', 'permian', 'haynesville', 'storage-midwest'],
  },
  {
    id: 'eia-tie-67166',
    title: 'U.S. natural gas production to reach record highs in 2026 and 2027',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    ...
    summary:
      'February 2026 STEO TIE: 120.8 Bcf/d in 2026 then 122.3 in 2027. ~69% from Appalachia, Haynesville, Permian. Earlier vintage than 67944; same family.',
    keyClaims: [
      'Three-basin concentration of growth.',
      'Haynesville responds to HH; Permian to oil + GOR.',
    ],
    tags: ['EIA', 'STEO', 'Appalachia', 'Haynesville', 'Permian'],
    relatedness: 73,
    mapFocus: ['appalachia', 'haynesville', 'permian'],
  },
  {
    id: 'eia-tie-67345',
    title: 'U.S. natural gas production reached a new record in 2025',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    stance: 'balanced',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67345',
    summary:
      'Natural Gas Monthly wrap: 118.5 Bcf/d marketed in 2025 (+5.3). Appalachia + Permian + Haynesville = 67% of output and 81% of growth. Permian 27.7 Bcf/d (+11%). Haynesville 14.9 Bcf/d.',
    keyClaims: [
      '2025 already a production record.',
      'Permian was about half of 2025 growth.',
    ],
    tags: ['EIA', 'Natural Gas Monthly', 'production'],
    relatedness: 71,
    mapFocus: ['permian', 'haynesville', 'appalachia'],
  },
  {
    id: 'eia-tie-67785',
    title: 'Permian natural gas production increased faster than crude oil',
    authors: 'Naser Ameen, Troy Cook',
    org: 'EIA Today in Energy',
    year: 2026,
    kind: 'agency',
    stance: 'balanced',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67785',
    summary:
      'GOR mechanics Chronometer cites as associated-gas decline risk: Permian gas +60% (17.2→27.6 Bcf/d) vs oil +39% (2021-2025). GOR ~4,200 cf/b in 2025 (+16% vs 2021). Extra ~3.8 Bcf/d in 2025 from GOR alone. Official view: GOR still rising, so gas can grow even if oil-directed rigs stall.',
    keyClaims: [
      'GOR lift added ~3.8 Bcf/d vs a frozen-2021-GOR counterfactual.',
      'Associated gas is not a 1:1 slave to oil rigs.',
    ],
    tags: ['EIA', 'Permian', 'GOR', 'associated gas'],
    relatedness: 78,
    mapFocus: ['permian'],
  },
  {
    id: 'eia-tie-67745',
    title: 'U.S. natural gas storage capacity increased slightly in 2025',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    stance: 'tight',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67745',
    summary:
      'Working-gas capacity in the Lower 48 rose only slightly in 2025. That is the official version of Chronometer’s “storage +7% then +2%” cushion story: capacity barely moves while production and LNG nameplate do.',
    keyClaims: [
      'Working-gas nameplate is almost flat.',
      'Days-to-cover can fall even when inventories look healthy.',
    ],
    tags: ['EIA', 'storage', 'capacity'],
    relatedness: 76,
    mapFocus: ['storage-midwest'],
  },
  {
    id: 'eia-tie-67524',
    title: 'Natural gas inventories at the end of winter heating season',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    stance: 'balanced',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67524',
    summary:
      'End of 2025-26 winter: 1,890 Bcf working gas to start injection, 3% above 5-year. Record 360 Bcf weekly draw (Winter Storm Fern) then a rebound. STEO then expected 2,125 Bcf of injections. Near-term stocks can be ample even after a record withdrawal week.',
    keyClaims: [
      'One brutal week does not empty the system.',
      'Injection-season rebuild is the official base case.',
    ],
    tags: ['EIA', 'storage', 'winter', 'weather'],
    relatedness: 67,
    mapFocus: ['storage-midwest'],
  },
  {
    ...
    summary:
      'The actual weekly working-gas print (Lower 48 + regions). This is the live series behind “days-to-cover” and 5-year-average charts. Not a thesis; the scoreboard.',
    keyClaims: [
      'Thursday EIA print is the storage ground truth.',
      'Use with STEO, not instead of a 2030 model.',
    ],
    tags: ['EIA', 'storage', 'weekly', 'data'],
    relatedness: 75,
    mapFocus: ['storage-midwest'],
  },
  {
    ...
    summary:
      'Monthly rig + new-well + legacy-decline gas (and oil) for Permian, Haynesville, Appalachia, Bakken, Eagle Ford. The official basin dashboard for whether +20 Bcf/d of deliverability is showing up in wells, not just letters.',
    keyClaims: [
      'Tracks the three basins that dominate STEO growth.',
      'Legacy decline vs new-well gas is the real supply treadmill.',
    ],
    tags: ['EIA', 'DPR', 'rigs', 'basins'],
    relatedness: 77,
    mapFocus: ['permian', 'haynesville', 'appalachia'],
  },
  {
    id: 'eia-tie-67365',
    title: 'U.S. natural gas consumption set a monthly and yearly record in 2025',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    stance: 'growth',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67365',
    summary:
      'Demand side of the same official ledger: 92.0 Bcf/d average in 2025; January 126.6 Bcf/d winter record. +1.7 Bcf/d vs 2024. Complements production records so the debate is balance, not one leg.',
    keyClaims: [
      '2025 consumption also a record.',
      'Winter monthly peaks still set the storage-draw story.',
    ],
    tags: ['EIA', 'consumption', 'demand'],
    relatedness: 69,
    mapFocus: ['se-power', 'pjm-load', 'storage-midwest'],
  },
  {
    id: 'eia-tie-67686',
    title: 'U.S. industrial natural gas consumption expected to hit records',
    authors: 'EIA Today in Energy',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    stance: 'growth',
    url: 'https://www.eia.gov/todayinenergy/detail.php?id=67686',
    summary:
      'Industrial gas 23.6 Bcf/d in 2025 (record). STEO: +0.3 then +0.4 Bcf/d through 2027. Slow because efficiency offsets manufacturing. The non-AI, non-LNG demand leg Chronometer still has to clear.',
    keyClaims: [
      'Industrial is a record but a slow-growth leg.',
      'Efficiency offsets activity.',
    ],
    tags: ['EIA', 'industrial', 'manufacturing'],
    relatedness: 58,
    mapFocus: ['gulf-lng', 'se-power'],
  },
  {
    id: 'eia-ng-monthly',
    title: 'Natural Gas Monthly',
    authors: 'U.S. Energy Information Administration',
    org: 'EIA',
    year: 2026,
    kind: 'agency',
    ...
    summary:
      'Final monthly production, consumption, trade, and storage tables. TIE articles are the narrative layer; NGM is the table layer. Pair with STEO (forecast) and Weekly Storage (flash).',
    keyClaims: [
      'Best official monthly history for dry/marketed gas.',
      'Revisions matter; do not treat one TIE chart as final.',
    ],
    tags: ['EIA', 'monthly', 'tables'],
    relatedness: 70,
    mapFocus: ['permian', 'haynesville', 'appalachia', 'gulf-lng'],
  },
  {
    id: 'nerc-ltra-2025',
